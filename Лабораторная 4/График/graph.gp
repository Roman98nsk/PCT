...
plot x title "Linear speedup" with lines lc rgb 'blue' lt 1 lw 2,\
     '1 версия.dat' using 1:2 title "V1" with linespoints ls 2,\
     '2 версия.dat' using 1:2 title "V2" with linespoints ls 3,\
     '3 версия.dat' using 1:2 title "V3" with linespoints ls 4,\
     '4 версия.dat' using 1:2 title "V4" with linespoints ls 5,\
     '5 версия.dat' using 1:2 title "V5" with linespoints ls 6
